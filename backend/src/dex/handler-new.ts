...
function handleApiInfo(corsHeaders: CorsHeaders): Response {
  return new Response(JSON.stringify({
    ...
    endpoints: {
      public: [
        'GET /api/v2/dex - API information',
        'GET /api/v2/dex/health - Health check'
      ],
      authenticated: [
        'GET /api/v2/dex/pools - List pools',
        'GET /api/v2/dex/tokens - List tokens',
        'GET /api/v2/dex/analytics - DEX analytics',
        'GET /api/v2/dex/pools/chain/:chainId - Pools by chain',
        'GET /api/v2/dex/pools/:poolId - Pool details',
        'GET /api/v2/dex/user/:userAddress/rewards - User rewards',
        'POST /api/v2/dex/rewards/batch-proof - Batch rewards proof',
        'GET /api/v2/dex/user/:userAddress/claimable-rewards - Claimable rewards',
        'GET /api/v2/dex/user/:userAddress/rewards/history - Rewards history',
        'GET /api/v2/dex/user/:userAddress/bin-ids - User bin IDs',
        'GET /api/v2/dex/user/:userAddress/pool-ids - User pool IDs',
        'GET /api/v2/dex/pool/:poolId/user/:userAddress/balances - Pool user balances',
        'GET /api/v2/dex/user/:userAddress/history - User history',
        'GET /api/v2/dex/user/:userAddress/fees-earned - User fees earned',
        'GET /api/v2/dex/user/:userAddress/lifetime-stats - User lifetime stats',
        'GET /api/v2/dex/user/:userAddress/farms - User farms',
        'GET /api/v2/dex/user/:userAddress/farms/:farmId - User farm details',
        'GET /api/v2/dex/vaults - All vaults',
        'GET /api/v2/dex/vaults/chain/:chainId - Vaults by chain',
        'GET /api/v2/dex/vault/:vaultId/share-price - Vault share price',
        'GET /api/v2/dex/vault/:vaultId - Vault details',
        'GET /api/v2/dex/vault/:vaultId/tvl-history - Vault TVL history',
        'GET /api/v2/dex/vault/:vaultId/recent-activity - Vault recent activity',
        'GET /api/v2/dex/user/:userAddress/vault-withdrawals - Vault withdrawals by user',
        'GET /api/v2/dex/user/:userAddress/vault/:vaultId/withdrawals - Vault withdrawals by user and vault'
      ]
    },
    authentication: {
      type: 'API Key',
